...
draw.rectangle([0, 0, border_width, height], fill=(0, 102, 255)) #Left border| fill is a user editable value <<<<<
draw.rectangle([0, 0, width, border_width], fill=(204, 102, 255)) #Top border| fill is a user editable value <<<<<
draw.rectangle([width - border_width, 0, width, height], fill=(255, 102, 153)) # Right| fill is a user editable value <<<<<

# Draw the rainbow at the bottom
rainbow_colors = [(153, 0, 51), (255, 153, 0), (255, 204, 0), (0, 153, 51), (0, 102, 255), (75, 0, 130), (204, 102, 255)]
rainbow_width = int(1024 / len(rainbow_colors))
for i in range(len(rainbow_colors)):
    draw.rectangle((i * rainbow_width, 556, (i + 1) * rainbow_width -1 ,576), fill=rainbow_colors[i])
...
draw.text((width//2 - 100, 10), "BADestJUJU", fill=(153, 0, 51), font=font)
...
draw.text((width - 576,height - 20), "Let's fine tune mon stream together", fill=(255,255,255), font=font)

# Save the image to a file
img.save("overlayOver9000.png")
